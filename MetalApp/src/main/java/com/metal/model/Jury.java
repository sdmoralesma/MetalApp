...
public class Jury implements Serializable {
	...
	@ManyToMany	
	@JoinTable(name = "jury_presentation", joinColumns = { @JoinColumn(name = "jury_id_jury", nullable = false) }, inverseJoinColumns = { @JoinColumn(name = "presentation_id_presentation", nullable = false) })
