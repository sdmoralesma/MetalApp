...
VALUES ('admin1', 'admin', 'admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg='),
  ('admin2', 'admin', 'admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg='),
  ('jury1', 'jury', 'jury', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg='),
  ('jury2', 'jury', 'jury', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg='),
  ('pepe1', 'participant', 'participant', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg='),
  ('pepe2', 'participant', 'participant', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=');

-- Data for table `admin`
INSERT INTO `admin` (`USERNAME`, `DESCRIPTION`, `NAME`)
VALUES ('admin1', 'A great admin', 'the Admin N1 '), ('admin2', 'Other admin', 'the Admin N2');

-- Data for table `jury`
INSERT INTO `jury` (`USERNAME`, `DESCRIPTION`, `NAME`)
VALUES ('jury1', 'the great Jury1', 'Name jury1'), ('jury2', 'other jury', 'Name jury2');

-- Data for table `participant`
INSERT INTO `participant` (`USERNAME`, `AGE`, `COUNTRY`, `GENDER`, `IMAGE_URL`, `NAME`)
VALUES ('pepe1', 53, 'Colombia', 'Male', 'hello', 'Pepe The First'),
  ('pepe2', 35, 'Peru', 'Female', NULL, 'Pepe The Second');
